//! IAPWS-95 Residual Part Implementation (Direct Power Computation)
//!
...
//!
//! This version uses direct `powi`/`powf` calls for power computation,
//! without precomputing power arrays. Used for performance comparison.
//!
//! # Formula
//!
//! ```text
...
#[inline]
pub fn phi_residual_direct(delta: f64, tau: f64) -> f64 {
    let mut sum = 0.0f64;
...
#[inline]
pub fn dphi_residual_ddelta_direct(delta: f64, tau: f64) -> f64 {
    let mut sum = 0.0f64;
...
#[inline]
pub fn d2phi_residual_ddelta2_direct(delta: f64, tau: f64) -> f64 {
    let mut sum = 0.0f64;
...
#[inline]
pub fn dphi_residual_dtau_direct(delta: f64, tau: f64) -> f64 {
    let mut sum = 0.0f64;
...
#[inline]
pub fn d2phi_residual_dtau2_direct(delta: f64, tau: f64) -> f64 {
    let mut sum = 0.0f64;
...
#[inline]
pub fn d2phi_residual_ddelta_dtau_direct(delta: f64, tau: f64) -> f64 {
    let mut sum = 0.0f64;
